...
const styles: Record<string, React.CSSProperties> = {
  ...
  cancelBtn: {
    ...
    border: "1px solid var(--muxpit-hairline-strong, #45475a)",
    borderRadius: 4,
    color: "var(--muxpit-subtext, #a6adc8)",
    fontSize: 12,
    padding: "5px 14px",
    cursor: "pointer",
  },
  confirmBtn: {
    background: "var(--muxpit-accent, #89b4fa)",
    border: "none",
    borderRadius: 4,
    color: "var(--muxpit-bg, #1e1e2e)",
    fontSize: 12,
    fontWeight: 600,
    padding: "5px 14px",
    cursor: "pointer",
