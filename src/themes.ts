...
export const applyThemeVars = (theme: TerminalTheme): void => {
  ...
  root.style.setProperty("--muxpit-bg", darken(bg, 0.4));
  root.style.setProperty("--muxpit-bg-soft", bg);
  root.style.setProperty("--muxpit-bg-elev", "rgba(255, 255, 255, 0.025)");
  root.style.setProperty("--muxpit-text", text);
  root.style.setProperty("--muxpit-subtext", subtext);
  root.style.setProperty("--muxpit-hairline", "rgba(255, 255, 255, 0.06)");
  root.style.setProperty("--muxpit-hairline-strong", "rgba(255, 255, 255, 0.10)");
  root.style.setProperty("--muxpit-accent", accent);
  root.style.setProperty("--muxpit-accent-2", accent2);
  root.style.setProperty("--muxpit-accent-soft", hexToRgba(accent, 0.07));
  root.style.setProperty("--muxpit-accent-mid", hexToRgba(accent, 0.18));
